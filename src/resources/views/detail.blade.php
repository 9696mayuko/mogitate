...
<head>
    ...
    <title>商品一覧ページ</title>
    <link rel="styleseet" href="{{ asset('css/sanitize.css') }}" />
    <link rel="styleseet" href="{{ asset('css/detail.css') }}" >
    <link rel="styleseet" href="{{ asset('css/header.css') }}" />
</head>
    ...
    <div class="all-contents">
        <form action="/products/update" method="POST">
            ...
            <div class="top-contents">
                ...
                <div class="right-cpmtent">
                    <label class="name-lable">商品名</label>
            ...
            <div class="under-content">
                ...
                @error('product_image')
                <span class="input_error">
                    <p class="input_error_message">{{$error->first('product_image')}}</p>
                </span>
                @enderror
                <label class="description-label">商品説明</label>
                <textarea cols="30" rows="5" name="procuct_description" class="product-description">{{$product->description}}</textarea>
                @error('procuct_description')
                    <span class="input_error">
